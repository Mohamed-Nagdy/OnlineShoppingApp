...
class UpdateSubCategoryScreen extends StatefulWidget {
  static String id = '/updateSubcategoryScreen';
  @override
  _UpdateSubCategoryScreenState createState() =>
...
class _UpdateSubCategoryScreenState extends State<UpdateSubCategoryScreen> {
  ...
  @override
  void initState() {
    _image = base64Decode(Get.arguments['subcategory'].image.toString());
    id = Get.arguments['subcategory'].id;
    categoryId = Get.arguments['subcategory'].category;
    subCategoryName =
        TextEditingController(text: Get.arguments['subcategory'].name);
                                    ...
                                    if (key.currentState.validate()) {
                                      ...
                                      try {
                                        ...
                                        var response = await dio.patch(
                                          'https://nada-app-control-panel.herokuapp.com/api/v1/subCategory/$id',
                                          data: {
